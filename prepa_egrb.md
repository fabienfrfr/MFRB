...
**Note de définition :** *L'IA, ou intelligence artificielle est devenu tellement commun, qu'on ne sait plus vraiment le sens, j'utilise plutot machine learning en général, mais il faut avouer que ce terme n'est pas non plus neutre (idéologiquement parlant). Personnellement, je prefere parler de "predictive data processing", car il permet d'indiquer que l'enjeux et sur le calcul et sur les données, mais aussi que ce n'est que des outils de prédictions sophistiqué, adapté pour des problemes complexes.*
