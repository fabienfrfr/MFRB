...
\paragraph*{Endogenous Demand Feedback}
The lack of macroeconomic feedback can be addressed by making firm profits dependent on aggregate automation ($\overline{a}$). This entails transforming the profit function to $\Pi_{i}(a_{i},\overline{a}_{-i}, \overline{a})$, where $\overline{a}$ inversely scales total market demand due to the wage-based demand collapse. This step is critical, as it allows for an \textit{endogenous self-correction} mechanism: excessive collective automation would diminish market size and profits for all firms, potentially slowing the automation race without external policy.
